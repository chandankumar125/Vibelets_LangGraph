...
export function getIntentDescription(intent: string, currentStep: CampaignStep): string {
    const descriptions: Record<string, string> = {
        ...
        'generate_images': 'Regenerate creative images',
        'generate_audio': 'Regenerate audio',
        'generate_video': 'Regenerate video',
        'refine_images': 'Refine the generated images',
        'creative-review': 'Go back to creative selection',
        'select_media': 'Go back to creative selection',
        'campaign-setup': 'Go back to campaign configuration',
        'refine_campaign': 'Go back to campaign configuration',
